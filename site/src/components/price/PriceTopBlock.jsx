...
function PriceTopBlock() {
  return (
    <div className="mt-1 px-4 bg-Nblue h-[160px] md:h-[210px] flex justify-center items-center">
      <h2
        className=" text-white text-2xl md:text-4xl font-extrabold tracking-wide sm:text-4xl  text-center  relative inline-block after:content-[''] after:block after:w-32 after:h-1 after:mt-3 after:mx-auto after:bg-Ngold"
        style={{
