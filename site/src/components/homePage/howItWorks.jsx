...
const HowItWorks = () => {
  ...
  return (
    <div className="w-full py-12 bg-gray-100 text-center">
      <h2 className="text-3xl  sm:text-4xl font-bold font-roboto text-center  text-Ndark relative inline-block after:content-[''] after:block after:w-20 after:h-1 after:mt-3 after:mx-auto after:bg-Nblue mb-7">
        Як це працює ?
      </h2>
