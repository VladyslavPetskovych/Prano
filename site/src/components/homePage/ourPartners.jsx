...
export const partners = [
  ...
  { id: 4, src: aristo, alt: "Aristo Partner Logo" },
  { id: 5, src: austrian, alt: "Austrian Partner Logo" },
  { id: 6, src: royal, alt: "Royal Partner Logo" },
];
...
function OurPartners() {
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden bg-gray-100 py-10">
      <h2 className="text-3xl  sm:text-4xl font-bold text-center mb-12 text-gray-800 relative inline-block after:content-[''] after:block after:w-20 after:h-1 after:mt-3 after:mx-auto after:bg-blue-500">
        Наші партнери
      </h2>

      <div className="relative w-full flex overflow-hidden">
        <div className="flex min-w-max animate-marquee hover:[animation-play-state:paused] gap-x-8">
